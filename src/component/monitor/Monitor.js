...
class Monitor extends Component {
    constructor(props) {
        super(props);
        this.state = {totalPrice: 0, orders: [], confirm: false, msg: ""}; //สร้าง state ขึ้นมา
        this.addOrder = this.addOrder.bind(this); // เวลาเรียก this คือตัวมันเอง ไม่ใช่ตัวฟังชั่นที่ this อยุ
